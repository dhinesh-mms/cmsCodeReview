...
class Soap5 extends Soap4
{
    ...
    public function RegisterDisplay(
        ...
        if(!$conn) {
         ...
         $sql = "insert into XVSFDN.DISPLAY_HISTORY(ID,DISPLAYID,DISPLAY,FIRSTACCESSED,LASTACCESSED,LICENSE,IPADDRESS) values(displayhistory_seq.NEXTVAL,$display->displayId,'$displayName',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'$hardwareKey','$clientaddress')";
