...
class Stats extends Base
{
    ...
    public function export(Request $request, Response $response)
    {
        ...
        fputcsv($out, ['Stat Date', 'Type', 'FromDT', 'ToDT', 'Layout', 'Campaign', 'Display', 'Media', 'Tag', 'Duration', 'Count']);
        ...
        while ($row = $resultSet->getNextRow() ) {
            ...
            fputcsv($out, [$statDate, $type, $fromDt, $toDt, $layout, $parentCampaign, $display, $media, $tag, $duration, $count]);
        }
