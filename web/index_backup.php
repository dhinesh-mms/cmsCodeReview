...
->setDefaultErrorHandler(
    function ($request, $response, $exception) use ($app) {
        ...
        $twigMiddleware = $app->getContainer()->get(TwigMiddleware::class);
        $twigEnvironment = $twigMiddleware->getTwigEnvironment();
        //$twigEnvironment->enableDebug();

        // Call the original error handler
        return \Xibo\Middleware\Handlers::webErrorHandler($app->getContainer())($request, $response, $exception);
    }
);
